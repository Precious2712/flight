     <div className="flex min-h-screen flex-col bg-gradient-to-r from-gray-800 to-gray-900">
            ...
            <main className="flex-1">
                <section className="relative bg-gradient-to-r from-primary/90 to-primary py-20 md:py-32 px-6 overflow-hidden">
                ...
                <section className="py-16 bg-gradient-to-r from-gray-100 to-gray-200 px-7">
                                    ...
                                    <CardContent className="">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <Link to={destination.path}>
                                                <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">View Details</Button>
                                            </Link>
                                        </div>
                                    </CardContent>
                                </Card>
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm text-muted-foreground">Expires: {offer.expires}</span>
                                            </div>
                                        </div>
                                        <p className="mt-4 text-muted-foreground line-clamp-2">{offer.description}</p>
